...
// Comment out tests and functions that use code that you haven't implemented
// yet
...
TEST_SUITE("Object")
{
  TEST_CASE("Create object")
  {
    ...
    const Object object{
        {{"a", value}, {"b", new Integer{2}}, {"c", new Null{}}}};
...
TEST_SUITE("Clone")
{
  ...
  TEST_CASE("Array")
  {
    ...
    auto *value = new Array{{new Integer{1}, new Integer{1},
...
TEST_SUITE("Print")
{
  ...
  TEST_CASE("Empty array") { REQUIRE(print(Array{}) == "[]"); }

  TEST_CASE("Array")
  {
    auto *obj =
        new Object{{{"a", new Integer{5}},
  ...
  TEST_CASE("Empty object") { REQUIRE(print(Object{}) == "{}"); }
...
TEST_SUITE("Remove null")
{
  TEST_CASE("Remove null")
  {
    auto *object = new Object{{
        ...
        {"b", new Null{}},
        {"c", new Integer{2}},
        {"d", new Object{{{"a", new Null{}}, {"b", new Array({new Integer{1}, new Null{}, new Integer{3}, new Integer{2}, new Null{}})}}}},
    }};
